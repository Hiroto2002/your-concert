...
export default function Stopmiku({setStop,setModel,...props }) {
  const { nodes, materials, animations } = useGLTF('/model/miku_stop.glb')
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group name="Scene">
        ...
        <mesh name="立方体004" castShadow receiveShadow geometry={nodes.立方体004.geometry} material={materials['マテリアル.006']} position={[-0.75, 5.71, 1.46]} rotation={[-3.14, 0.01, 3.14]} scale={[0.13, 0.21, 0.13]} />
        ...
        <mesh name="Cube006" castShadow receiveShadow geometry={nodes.Cube006.geometry} material={materials.face} position={[0.1, 4.25, -0.4]} rotation={[-Math.PI, 0.01, -Math.PI]} scale={[0.56, 0.29, 0.56]} />
        <group name="Cube007" position={[0.1, 2.97, -0.4]} rotation={[-Math.PI, 0.01, -Math.PI]} scale={[1.62, 1.25, 0.81]}>
          <mesh name="Cube008_1" castShadow receiveShadow geometry={nodes.Cube008_1.geometry} material={materials.huku} />
          <mesh name="Cube008_2" castShadow receiveShadow geometry={nodes.Cube008_2.geometry} material={materials['マテリアル.014']} />
        </group>
        <mesh name="立方体002" castShadow receiveShadow geometry={nodes.立方体002.geometry} material={materials.huku} position={[0.48, 3.82, 0.64]} rotation={[0, 0, 2.13]} scale={[0.23, 0.38, 0.24]} />
      </group>
    </group>
...
useGLTF.preload('/model/miku.stop.glb')
